...
export const Modal = ({title = "", children, state, setState}: ModalProps) => {
    return (
        <div className={`absolute right-0 top-0 w-[100dvw] h-[100dvh] flex justify-center items-center bg-black bg-opacity-25 backdrop-blur-sm z-50 ${state ? "" : "hidden"}`} onClick={() => setState(false)}>
